...
export const EXERCISES: Exercise[] = [
  ...
  ex({
    ...
    orderCategory: 'isolation', unilateral: false,
  ...
  ex({
    ...
    orderCategory: 'compound', unilateral: false,
  ...
  ex({
    ...
    equipment: ['dumbbells', 'bench'], role: 'core', progression: 'reps', minIncrement: 2.5,
    unilateral: true, loads: L(), setsReps: { sets: 3, repMin: 8, repMax: 12 },
  ...
  ex({
    ...
    equipment: ['dumbbells'], role: 'core', progression: 'reps', minIncrement: 2.5, unilateral: true,
  ...
  ex({
    ...
    orderCategory: 'isolation',
    equipment: ['bodyweight'], progression: 'reps', minIncrement: 0, unit: 'bw', unilateral: true,
  ...
  ex({
    ...
    orderCategory: 'isolation',
    equipment: ['low_cable', 'ankle_strap'], role: 'core', unilateral: true, minIncrement: 1.25,
    loads: L('lateral_hip'),
  ...
  ex({
    ...
    orderCategory: 'isolation',
    equipment: ['mini_band'], role: 'core', progression: 'reps', minIncrement: 0, unit: 'band',
    unilateral: true, loads: L('lateral_hip'), setsReps: { sets: 3, repMin: 15, repMax: 20 },
    bodyweightAlternative: 'side_lying_abduction',
    progressesTo: 'cable_hip_abduction',
  }),
  ex({
    ...
    orderCategory: 'isolation',
    equipment: ['mini_band'], role: 'core', progression: 'reps', minIncrement: 0, unit: 'band',
    unilateral: true, loads: L('lateral_hip'), setsReps: { sets: 3, repMin: 15, repMax: 25 },
    bodyweightAlternative: 'side_lying_abduction',
  }),
  ex({
  ...
  ex({
    ...
    unilateral: true, loads: L(), setsReps: { sets: 3, repMin: 15, repMax: 25 },
  }),
  ex({
    id: 'side_plank_leg_lift', naam: 'Side plank met beenheffen', pattern: 'abduction',
    orderCategory: 'isolation',
    equipment: ['bodyweight'], role: 'core', progression: 'reps', minIncrement: 0, unit: 'bw',
    unilateral: true, loads: L('shoulder'), setsReps: { sets: 3, repMin: 8, repMax: 15 },
  }),

  /* ---------------- core (romp) ---------------- */
  ex({
    id: 'ab_roller_ex', naam: 'Ab roller', pattern: 'core', group: 'abs',
    orderCategory: 'core', unilateral: false,
  ...
  ex({
    ...
    orderCategory: 'core',
    equipment: ['bodyweight'], progression: 'reps', minIncrement: 0, unit: 'bw',
    unilateral: true, loads: L('shoulder'), setsReps: { sets: 3, repMin: 20, repMax: 45 },
    cue: 'Reps = seconden.',
  }),
  ex({
  ...
  ex({
    ...
    unilateral: true, loads: L(), setsReps: { sets: 3, repMin: 10, repMax: 15 },
  }),
  ...
  ex({
    ...
    unilateral: true, loads: L('knee_deep', 'lateral_hip'), setsReps: { sets: 3, repMin: 6, repMax: 10 },
    bodyweightAlternative: 'split_squat_bw',
  }),
  ex({
    id: 'single_leg_press', naam: 'Eenbenige leg press', pattern: 'single_leg',
    orderCategory: 'heavy_legs',
    equipment: ['leg_press', 'plates'], role: 'core', unilateral: true, loads: L('knee_deep'),
  ...
  ex({
    ...
    orderCategory: 'heavy_legs',
    equipment: ['dumbbells', 'bench'], role: 'core', progression: 'reps', minIncrement: 2.5,
    unilateral: true, loads: L('knee_deep', 'lateral_hip'), setsReps: { sets: 3, repMin: 8, repMax: 12 },
    bodyweightAlternative: 'step_up_bw',
  }),
  ex({
    id: 'reverse_lunge_sandbag', naam: 'Reverse lunge (schouderzak)', pattern: 'single_leg',
    orderCategory: 'heavy_legs',
    equipment: ['sandbag'], role: 'core', progression: 'reps', minIncrement: 5, unilateral: true,
    loads: L('knee_deep'), setsReps: { sets: 3, repMin: 8, repMax: 12 },
    bodyweightAlternative: 'split_squat_bw',
  }),
  ex({
  ...
  ex({
    ...
    orderCategory: 'heavy_legs',
    equipment: ['bodyweight'], role: 'core', progression: 'reps', minIncrement: 0, unit: 'bw',
    unilateral: true, loads: L('knee_deep'), setsReps: { sets: 3, repMin: 10, repMax: 20 },
  }),
  ex({
    id: 'step_up_bw', naam: 'Step-up (lichaamsgewicht)', pattern: 'single_leg',
    orderCategory: 'heavy_legs',
    equipment: ['bodyweight'], role: 'core', progression: 'reps', minIncrement: 0, unit: 'bw',
    unilateral: true, loads: L('lateral_hip'), setsReps: { sets: 3, repMin: 12, repMax: 20 },
  }),
  ex({
    id: 'single_leg_glute_bridge', naam: 'Eenbenige glute bridge', pattern: 'single_leg',
    orderCategory: 'isolation',
    equipment: ['bodyweight'], role: 'core', progression: 'reps', minIncrement: 0, unit: 'bw',
    unilateral: true, loads: L(), setsReps: { sets: 3, repMin: 12, repMax: 20 },
  }),
]
